var ACCSOffer = {
    ...
    closeOffer: function() {
        var e = document.getElementById("accs_survey_offer");
        null != e && (e.style.display = "none", e.style.visibility = "hidden")
    },
    ...
    injectOfferCss: function() {
        ...
        e.rel = "stylesheet", e.href = "https://www.apple.com/support/assets/css/global/survey/accs-offer.css", document.getElementsByTagName("head")[0].appendChild(e)
    },
    isAppleCom: function() {
    ...
    launchSurvey: function() {
        var e = window.open("https://www.apple.com/" + this.getData("locale_directory") + "support/survey/accs/", "ACCSPopunder", "toolbar=no,menubar=no,resizable=yes,scrollbars=yes,location=no,status=no,top=0,left=0,width=500,height=700");
        e.blur(), window.focus()
    },
    load: function(e) {
        var o = window.onload;
